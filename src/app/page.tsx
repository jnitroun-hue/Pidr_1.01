...
function HomeWithParams() {
  ...
  useEffect(() => {
    ...
    if (!isMiniApp) {
      console.log('🌐 Обнаружен браузер - показываем страницу входа/регистрации');
      // НЕТ АВТОАВТОРИЗАЦИИ - сразу показываем страницу входа/регистрации
      setIsBrowser(true);
      setLoading(false);
          ...
          >
            ...
            >
              <p style={{
                ...
                🎮 Увлекательная карточная игра нового поколения
              </p>
              <p style={{
                color: '#94a3b8',
                fontSize: '16px',
                ...
                Сражайся с друзьями, зарабатывай монеты, собирай NFT карты и становись чемпионом!
              </p>
            </motion.div>
