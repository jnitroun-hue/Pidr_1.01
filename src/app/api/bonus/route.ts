    ...
    return noStoreJson({
      ...
      bonuses: [
        ...
        },
        {
          ...
          description: 'Отправьте ссылку в Telegram, VK или любую соцсеть — друг регистрируется любым способом',
          reward: 'Вам +500 монет, другу +200',
          icon: '👥',
          available: true,
          completed: false,
          referrals: referralCount || 0,
          note: 'Счётчик — число друзей, которые зарегистрировались по вашей ссылке. Монеты начисляются сразу при их первом входе.',
        },
        {
