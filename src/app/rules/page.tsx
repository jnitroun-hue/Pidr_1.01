...
export default function RulesPage() {
  ...
  const rules = [
    ...
    {
      title: '2️⃣ Вторая стадия (Дурак)',
      icon: '🃏',
      content: [
        'Игра по правилам "Дурака"',
        'Бейте карты козырями или старшей картой той же масти',
        'Если не можете побить - берете все карты со стола',
        'Объявляйте "Одна карта!" когда остается последняя'
      ]
    },
    {
    ...
    {
      title: '⚠️ Система штрафов',
      icon: '💸',
      content: [
        'Если у вас осталась 1 карта - объявите "Одна карта!"',
        'Если не объявили и вас спросили - получаете штраф',
        'Штраф = все игроки сдают вам по 1 карте',
        'Игра останавливается пока все не сдадут штраф'
      ]
    },
    {
      title: '💎 NFT Карты',
