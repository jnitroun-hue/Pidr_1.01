...
const RULES = [
  ...
  },
  {
    ...
    content: [
      'У каждого игрока 1 открытая карта и 2 закрытые — это пеньки. Они лежат до 3 стадии.',
      'Пеньки нельзя смотреть или разыгрывать, пока не опустеет обычная рука после завершения колоды. Остальные карты образуют колоду.',
  ...
  },
  {
    ...
    content: [
      ...
      'Если забыли объявить, штраф включается только когда кто-то за столом успел первым спросить «Сколько карт?».',
      'Забывший получает по одной карте от всех остальных игроков за столом. Если объявление уже сделано или карта не одна, штрафа нет.',
    ],
  },
  {
